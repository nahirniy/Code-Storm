import{l as p,s as S,a as C}from"./assets/modal-subscription-0aa476b8.js";import"./assets/vendor-7a0e9089.js";const f=function(c){return c.map(({name:r,category:o,size:n,price:u,img:l,_id:y})=>`<li class="cart-item" data-id="${y}">
