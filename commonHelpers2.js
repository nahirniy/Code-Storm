import{l as i,c as ot,u as w,e as C,a as g,s as p,f as v,g as L,d as $,h as P,i as ct,j as rt,k as _,m as it,n as lt,o as dt}from"./assets/scroll-up-30a3bb62.js";import"./assets/vendor-9038a9ee.js";const E="basket",ut=document.querySelector(".product-list"),pt=i(E)??[];async function mt(t){const e=i(E)??[];if(!t.target.closest(".btn-basket"))return;const n=t.target.closest(".resp-item").dataset.id,o=i("main products").filter(({_id:r})=>n===r)[0],c=document.querySelectorAll(`[data-button-id="${n}"]`);w(E,o,e),C([...c],n,e)}ot(pt);ut.addEventListener("click",mt);const gt=document.querySelector(".product-list"),yt="main products";function x(t){g(yt,t);const e=i("basket")??[],s=t.map(n=>{const a=ft(n.category),o=ht(n.price),c=e.find(({_id:r})=>r===n._id);return`<li class="resp-item" data-id="${n._id}">
    ...
    <use class="href-icon" href="${p}#icon-basket"></use>
  </svg></button></div>`;Qt.innerHTML=q,O.style.display="block",document.body.style.overflow="hidden",j(),document.querySelector(".modal-button").addEventListener("click",et)}function se(t){const e=i("main products"),s=i("popular products"),n=i("discount products");return[...e,...s,...n].find(c=>c._id===t)}function ne(t,e){const s=se(t),n=document.querySelectorAll(`[data-button-id="${t}"]`);w(tt,s,e),C([...n],t,e);const a=e.find(c=>c._id===t),o=document.querySelector(".textInButton");a?o.textContent="Remove from":o.textContent="Add to"}Xt.addEventListener("click",F);te.addEventListener("click",F);ee.addEventListener("click",F);
